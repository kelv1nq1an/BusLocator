...
public class LineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_TIP) {
            return new TipViewHolder(mLayoutInflater.inflate(R.layout.item_tip, parent, false));
        } else {
            return new LineBusViewHolder(mLayoutInflater.inflate(R.layout.item_line, parent, false));
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof LineBusViewHolder) {
            position = position - 1;
            LineBusViewHolder holder = (LineBusViewHolder) viewHolder;
