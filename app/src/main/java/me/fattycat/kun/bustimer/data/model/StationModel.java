...
public class StationModel {
    ...
    public List<XiaxingEntity> getXiaxing() { return xiaxing;}

    public void setXiaxing(List<XiaxingEntity> xiaxing) { this.xiaxing = xiaxing;}

    public List<ShangxingEntity> getShangxing() { return shangxing;}

    public void setShangxing(List<ShangxingEntity> shangxing) { this.shangxing = shangxing;}
